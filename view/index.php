...
<body id="reportsPage">
    <div class="" id="home">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <p class="text-white mt-5 mb-5">Bienvenue</p>
                </div>
            </div>
            <!-- row -->
            <div class="row tm-content-row">
                ...
                <div class="col-12 tm-block-col">
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
                        <h2 class="tm-block-title">Liste des factures</h2>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">FACT NO.</th>
