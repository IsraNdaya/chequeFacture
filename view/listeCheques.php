        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-block-col">
          <div class="tm-bg-primary-dark tm-block tm-block-products">
            <div class="tm-product-table-container">
                <h2 class="tm-block-title">Liste des chèques</h2>
              <table class="table table-hover tm-table-small tm-product-table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">NUMERO CHEQUES</th>
                ...
                $listeCheques = ChequeDAO::getAllCheques();
                $compteur=1;
                foreach ($listeCheques as $line){
                    echo "<tr>";
                    echo "<td style=\"text-align: center;\">".$compteur."</td>";
                    echo "<td>"."CH000".$line['id']."</td>";
                    echo "<td>".$line['nomBeneficiaire']."</td>";
                    echo "<td>"."CDF  ".$line['montantNum']."</td>";
                    echo "<td>".$line['dateCheque']."</td>";
                    echo "<td style='text-align: left'> <a href='apercuCheque.php?id=".$line['id']."
                                                                                  &nomBeneficiaire=".$line['nomBeneficiaire']."
                                                                                  &montantNum=".$line['montantNum']."
                                                                                  &montantLettres=".$line['montantLettres']."
                                                                                  &datecheque=".$line['dateCheque']."
                                                                                  &observation=".$line['observation']."'
                                                     class='btn btn-primary btn-sm' >Aperçu</a>";
                    $compteur++;
                }
                ?>                </tbody>
              </table>
    ...
    <script>
      $(function() {
        $(".tm-product-name").on("click", function() {
          window.location.href = "facturePrint.php";
        });
      });
    </script>
  </body>
